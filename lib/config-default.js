...
module.exports = {
  'foursquare' : {
    ...
    /*
      This field will indicate which version of the Foursquare API you wish to call. If not specified,
      it will default to the minimum version that this library supports (currently 20131021).
      For more details, see https://developer.foursquare.com/overview/versioning
     */
    // 'version' : '20131021',
    /*
